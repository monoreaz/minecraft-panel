...
def create_password_reset_message(
    ...
    message["Subject"] = (
        "Reset your Minecraft Hosting password"
    )
    ...
    message.set_content(
        "Your Minecraft Hosting password reset "
    ...
    message.add_alternative(
        ...
        <body style="margin: 0; padding: 30px; background: #181818; color: #ffffff; font-family: Arial, sans-serif;">
            <div style="max-width: 520px; margin: 0 auto; padding: 30px; background: #252525; border: 1px solid #3a3a3a; border-radius: 14px;">
                <h1 style="margin: 0 0 18px;">Reset your password</h1>
...
def send_password_reset_email(
    ...
    message = create_password_reset_message(
        recipient_email,
        reset_code
    )
